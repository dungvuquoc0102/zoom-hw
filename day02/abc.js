...
autoAnswerLabel.style.fontFamily =
  '"Montserrat", "Noto Sans Arabic", "Helvetica Neue", Helvetica, Arial, sans-serif;';
...
showAnswersLabel.style.fontFamily =
  '"Montserrat", "Noto Sans Arabic", "Helvetica Neue", Helvetica, Arial, sans-serif;';
...
questionsLabel.style.fontFamily =
  '"Montserrat", "Noto Sans Arabic", "Helvetica Neue", Helvetica, Arial, sans-serif;';
...
inputLagLabel.style.fontFamily =
  '"Montserrat", "Noto Sans Arabic", "Helvetica Neue", Helvetica, Arial, sans-serif;';
...
function handleInputChange() {
  ...
  if (quizID != "") {
    fetch(url, {
      headers: {
        Authorization:
          "Bearer eyJraWQiOiJTZmRDOUNBOHlyT2dhOEVMUWxEODFyWWV2d1NicEE5cWxTb0siLCJ0eXAiOiJhY2Nlc3Mrand0IiwiYWxnIjoiUlMyNTYifQ..ABtlHlzEqVkUAD5Cn9_7S1LWA1OTVGP4myJ2Y5P-7PR5aaeIfq08W5-Hd5Hwy6JtuE6w6Ddh_EqI3nOptoaygnAFk-uQliDrUk4lplGB_QCbIwOjjzOfqw98_TGsm-mduiIz_xNriRcKzcJluiboqUHtY4zwd_8E4Ff4DZ7I3yMpsjxZiCpANEEnqnWc8Lnfk2nITKnBMLwBB_WGvJJGT49nIrEyBZ1uSfQRcrCjhx3DEQglkaxtihBA1wOsOWBI8EuGChSfRfSqXYDlHG4blosyhd08O_AYLuvO37ssRnY0TsizO5-7QSx4wAWFTNbw1-iwIWdgTyo65JJxzLze-A",
      },
    })
      .then((response) => {
        if (!response.ok) {
...
function onQuestionStart() {
  ...
  if (autoAnswer) {
    answer(
      question,
      question.time - question.time / (500 / (PPT - 500)) - inputLag
    );
  }
}
...
setInterval(function () {
  var textElement = FindByAttributeValue(
    "data-functional-selector",
  ...
  if (autoAnswer) {
    if (info.ILSetQuestion != info.questionNum) {
      ...
      if (ppt > 987) ppt = 1000;
      var incrementElement = FindByAttributeValue(
        "data-functional-selector",
        "score-increment",
        "span"
      );
